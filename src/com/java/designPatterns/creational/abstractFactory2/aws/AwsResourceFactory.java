package com.java.designPatterns.creational.abstractfactory2.aws;
...
public class AwsResourceFactory implements ResourceFactory {
    ...
    public Instance createInstance(Capacity capacity) {
        return new com.java.designPatterns.creational.abstractfactory2.aws.Ec2Instance(capacity);
    }
